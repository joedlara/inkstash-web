        ...
        <div className="footer-columns">
          <div className="footer-column">
            ...
            <ul>
              ...
              <li><button onClick={() => navigate('/affiliates')}>InkStash Affiliates</button></li>
            </ul>
          </div>
          ...
          <div className="footer-column">
            <h3>Get Help</h3>
            <ul>
              <li><button onClick={() => navigate('/order-status')}>Order Status</button></li>
              <li><button onClick={() => navigate('/shipping')}>Shipping and Delivery</button></li>
              <li><button onClick={() => navigate('/returns')}>Returns</button></li>
              <li><button onClick={() => navigate('/payment')}>Payment Options</button></li>
      ...
      <div className="footer-bottom">
        <div className="footer-bottom-container">
          <div className="footer-legal">
            <span>© {new Date().getFullYear()} InkStash Inc.</span>
